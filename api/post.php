<?php
    ...
    $options = array(
        'http' => array(
            ...
            'content' => 'data=[{"type":"flight","number":"SK22","from":"Stockholm","to":"New York JFK","seat":"7B","gate":"45b","ticketCounter":""},{"type":"flight","number":"SK455","from":"Gerona Airport","to":"Stockholm","seat":"3A","gate":"45b","ticketCounter":"344"},{"type":"bus","number":"","from":"Barcelona","to":"Gerona Airport","seat":""},{"type":"train","number":"78A","from":"Madrid","to":"Barcelona","seat":"45b"}]'
        )
    );
